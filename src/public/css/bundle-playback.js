...
!(function (t) {
    ...
    function a(t, e, n, r) {
      return (
        ...
        Object(o.a)(
          ...
          function (t) {
            401 === t.status
              ? r.userNotLoggedIn && r.userNotLoggedIn(t)
              : t.status >= 400
              ? r.failure && r.failure(t)
              : r.success && r.success(t);
          },
          { "Content-Type": "application/json" },
          s.stringify({ url: t, snapshot: e, tags: n || [] })
        ),
        !1
      );
    }
            ...
            value: function (t) {
              401 == t.status
                ...
                : (this.hide([
                  ...
                  console.log('Response: "' + t.responseText + '"'),
  ...
  function (t, e, n) {
    ...
    n.r(e);
    var r,
      i = { createElementNS: document.createElementNS };
    var s = !0;
    function a(t) {
      s = t;
    }
    ...
    var u = n(0),
      ...
      h = window.Date;
    function p(t, e) {
      return (t = t.toString()).length >= e
        ? t
        : "00000000".substring(0, e - t.length) + t;
    }
    function d(t) {
      for (var e = 0, n = 0; n < t.length; n++)
        e = Math.max(e, Math.max.apply(null, t[n][1]));
      if (
        (function (t) {
          for (var e = 0, n = 1e3, o = 0; o < t.length; o++) {
            var r = t[o];
            (e = Math.max(e, Math.max.apply(null, r[1]))),
                  ...
                  if (null == e) console.log("%s: no Memento-Datetime", u);
                    ...
                    var n = document.createElement("span"),
                      a = (function (t, e) {
                        ...
                        var r = !1;
                        if (n < 1e3)
                          return { delta: n, text: "", highlight: r };
                        var i = n,
                        ...
                        s > 1
                          ? (h.push(s + " years"), (r = !0))
                          : 1 == s && (h.push(s + " year"), (r = !0));
                        a > 1
                          ? (h.push(a + " months"), (r = !0))
                          : 1 == a && (h.push(a + " month"), (r = !0));
                        c > 1
                          ? h.push(c + " days")
                          : 1 == c && h.push(c + " day");
                        l > 1
                    ...
                    (f.innerHTML = u.split("/").splice(3).join("/")),
                      (f._wm_href = u),
                      (f.title = l),
                      (f.onmouseover = w),
                      (f.onmouseout = S);
                    var h = document.createElement("div");
                    h.setAttribute("data-delta", a.delta),
                      h.appendChild(f),
                      h.append(n),
                      o.appendChild(h);
    ...
    function g(t, e) {
      for (
        var n = e.split("/").splice(6).join("/"),
          o = t.document.querySelectorAll(
            "img[src$='" +
              n +
              "'], iframe[src$='" +
              n +
    ...
    function b(t) {
      return "FRAME" == t.tagName || "IFRAME" == t.tagName
    ...
    function w(t) {
      ...
      if (e.length > 0)
        for (var n = 0; n < e.length; n++)
          b(e[n]).classList.add("wb-highlight");
    }
    function S(t) {
      var e = g(window, t.target.href);
      if (e.length > 0)
        for (var n = 0; n < e.length; n++)
          b(e[n]).classList.remove("wb-highlight");
    }
    function T(t, e) {
      for (
    ...
    function H(t, e, n, o) {
      O(o || document, e, function (e) {
        for (var o, r = e.target || e.srcElement; r && !(o = k(r, t)); )
          r = r.parentElement;
        o && n.call(r, e);
      });
    }
    var j = (function () {
        function t(e, n) {
          ...
          (this.autocompleteAttr = e.getAttribute("autocomplete")),
            ...
            O(window, "resize", this.updateSC),
            O(e, "blur", this.blurHandler),
            O(e, "keydown", this.keydownHandler),
            O(e, "keyup", this.keyupHandler),
            this.minChars || O(e, "focus", this.focusHandler);
          var o = this;
          H(
          ...
          x(t, [
            {
              ...
              value: function () {
                E(window, "resize", this.updateSC),
                  E(this.input, "blur", this.blurHandler),
                  E(this.input, "focus", this.focusHandler),
                  E(this.input, "keydown", this.keydownHandler),
                  E(this.input, "keyup", this.keyupHandler),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (
                  ((this.cache[e] = t), t.length && e.length >= this.minChars)
                ) {
                  for (var n = "", o = 0; o < t.length; o++)
                    n += this.renderItem(t[o], e);
              ...
              value: function (t) {
                ...
                if ((40 == o || 38 == o) && this.sc.innerHTML)
                  return (
                    (r = this.sc.querySelector(
                      ...
                      ? (e = 40 == o ? r.nextSibling : r.previousSibling)
                        ? ((r.className = r.className.replace("selected", "")),
                          (e.className += " selected"),
                          (this.input.value = e.getAttribute("data-val")))
                        : ((r.className = r.className.replace("selected", "")),
                ...
                if (27 == o)
                  ...
                  (r = this.sc.querySelector(
                    ...
                    (this.onSelect(t, r.getAttribute("data-val"), r),
                    setTimeout(function () {
            ...
            { key: "onSelect", value: function (t, e, n) {} },
          ]),
          t
        );
      })(),
    ...
    var Y,
      $ = "/static/";
    function J(t) {
      U.classList.contains("wm-closed")
        ? (t && P.classList.add("notice-only"),
          U.classList.replace("wm-closed", "wm-open"),
          (P.style.display = "block"),
          y(Y, $, X))
        : (U.classList.replace("wm-open", "wm-closed"),
          (P.style.display = "none"),
          P.classList.remove("notice-only"));
    }
    function G(t, e) {
      var n = X(t);
    ...
    function K(t, e, n) {
      !(function (t, e) {
        ...
        "/web/" + e + "/http://web.archive.org/screenshot/" + t,
        function (t, o) {
          if (!t) return n(!1);
          var r = (function (t) {
            var e = V.exec(t);
          ...
          if (!r)
            return (
              console.warn("failed to extract timestamp from %s", o), void n(!1)
            );
    ...
    window.__wm = {
      init: function (t) {
        !(function () {
          ...
          (o = t),
          (document.createElementNS = function (t, e) {
            return (
              0 == t.indexOf(o) &&
                (t = t.substring(o.length).replace(/\/?[0-9]+\//, "")),
              i.createElementNS.call(this, t, e)
            );
          });
      },
      wombat: function (t, e, n, o, i, a) {
        ...
        i.startsWith(n) ||
          i.startsWith(u) ||
          (f.push(i), /^\/\//.test(i) ? f.push(l.protocol + i) : /^\//.test(i));
        var h = new URL(t),
          p = {
            url: t,
            timestamp: e,
            ...
            wombat_ts: e,
            wombat_sec: a,
            wombat_scheme: (h.protocol || "http").replace(/:$/, ""),
            wombat_host: h.host,
            wombat_opts: { no_rewrite_prefixes: f },
          };
        if ("undefined" != typeof _WBWombat) {
          var d = _WBWombat.prototype.rewriteUrl;
          return (
            (_WBWombat.prototype.rewriteUrl = function (t) {
              for (
                ...
                n[o - 1] = arguments[o];
              return s ? d.call.apply(d, [this, t].concat(n)) : t;
            }),
            ((r = _WBWombat(window, p)).actual = !0),
      ...
      bt: function (t, e, n, o, r, i, s, a, l, m, v) {
        ...
        var g,
          ...
          O = X("wm-ipp-base");
        if (O.attachShadow) {
          var E = O.attachShadow({ mode: "closed" });
          ...
          if (m)
            for (var H = 0; H < m.length; H++) {
              ...
              j.setAttribute("rel", "stylesheet"),
                ...
                j.setAttribute("href", m[H]),
                E.appendChild(j);
            }
        }
        function N() {
          var t =
            X("donato").offsetHeight +
            (X("wm-ipp-inside").offsetHeight - X("wm-capinfo").offsetHeight);
          console.debug("adjustHeight: baseHeight=%s", t + "px"),
            (O.style.height = t + "px");
        }
            ...
            window.addEventListener(
              ...
              function (t) {
                if (t.source === Q) {
                  ...
                  if (
                    (console.log("got message %o", e), "set height" == e.event)
                  ) {
                    var n = e.value,
                      o = e.bannerHeight;
                    ...
                    if ((e.value, G)) return;
                    (Z.style.height = o + "px"),
                      (tt.style.height = n + "px"),
                      N();
                  } else if ("open modal" == e.event)
                    (tt.style.height = ""),
                      document.body.classList.add("wm-modal"),
                      window.scrollTo(0, 0),
                      (G = !0);
                  else if ("close modal" == e.event)
              ...
              console.debug(
                "installed message listener to #donato-base: %o",
                tt
              );
          }
          ...
          if (e !== g) {
            ...
            e
              ...
              : ((n.className = ""),
                ...
                (r.innerHTML = f.b(_ - 1)),
                (i.innerHTML = p(C, 2))),
              (b.style.display = e ? "inline" : "none"),
              (w.style.display = e ? "inline" : "none"),
              (g = e);
          }
        }
        (U = X("wm-expand")),
          (P = X("wm-capinfo")),
          (X("wm-graph-anchor")._no_rewrite = !0),
          ((b = F.createElement("div")).className = "yt"),
          (b.style.display = "none"),
          (b.style.width = n + "px"),
          (b.style.height = e + "px"),
          ((w = F.createElement("div")).className = "mt"),
        ...
        (et.onmouseenter = nt),
          ...
          (et.onmousemove = function (e) {
            ...
            (X("displayYearEl").innerHTML = m + a),
              (X("displayMonthEl").innerHTML = f.b(v));
            var M = S + T + "/" + i;
        ...
        if (rt.getContext && rt.getContext("2d")) {
          ...
          (st.src =
            ...
            (st.width = t),
            (st.height = e),
            (st.id = "sparklineImgId"),
            (st.border = "0"),
            ot.parentNode.replaceChild(st, ot);
        }
        function at(t) {
          for (var e = [], n = t.length, o = 0; o < n; o++)
            void 0 === t[o].excluded && e.push(t[o].display_name);
          return e;
        }
        (X("wm-share-facebook").onclick = function (t) {
          ...
          new L(X("wmtbURL"), {
            ...
            source: function (t, e) {
              Object(u.a)(
                "GET",
                "/__wb/search/host?q=" + encodeURIComponent(t),
                function (n) {
                  if (
                    void 0 !== (n = I.parse(n.response)).hosts &&
                    n.hosts.length > 0
                  ) {
                    var o = at(n.hosts);
                    e(o);
                    ...
                    void 0 === n.excluded
                      ...
                      : Object(u.a)(
                          "GET",
                          "/__wb/search/anchor?q=" + encodeURIComponent(t),
                          function (t) {
                            if (
                              void 0 !== (t = I.parse(t.response)) &&
                              t.length > 0
                            ) {
          ...
          (X("wmtb").onsubmit = function (t) {
            ...
            if (
              0 !== e.indexOf("http://") &&
              0 !== e.indexOf("https://") &&
              !e.match(/[\w\.]{2,256}\.[a-z]{2,4}/gi)
            )
              return (
                (document.location.href = "/web/*/" + X("wmtbURL").value),
                t.preventDefault(),
                !1
              );
          }),
          (function (t, e) {
            K(t, e, function (t, e) {
              t
                ? ((X("wm-screenshot").title =
                    "screen shot (delta: " + e + "s)"),
                  z("wm-screenshot", !0))
                : z("wm-screenshot", !1);
            });
          })(i, Y),
            ...
            (function (t, e) {
              !(function (t, e, n) {
                ...
                if (t.status < 300) {
                  ...
                  z("wm-video", !0),
                    (X("wm-video").href = e.url),
                    (X("wm-video").title = "Video: " + e.title);
                } else z("wm-video", !1);
              });
            })(i, Y);
          ...
          if ("api" == ct.getAttribute("source")) {
            var lt =
              "https://wayback-api.archive.org/services/context/notices?url="
                .concat(encodeURIComponent(i), "&timestamp=")
                .concat(Y);
            B(lt, { credentials: "omit" })
              .then(function (t) {
                return t.json();
              })
              .then(function (t) {
                var e = t.status,
                  n = t.notices;
                if ("success" == e && (null == n ? void 0 : n.length) > 0)
                  try {
